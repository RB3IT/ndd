...
SLATLOOKUP =collections.OrderedDict([
    ...
    ("2 7/8 INCH CROWN SLAT",dict(slatheight = 2.875, increaseradius = .6,
           GAUGE={
               18:dict(SG = "18", slatweight=.071269154), ## NOTE: Either this or 2-1/2" should be incorrect
...
"""
    ...
    Keys-
        ...
        type: String, Casting Type (pipe or spring)
        springs: Int, Number of springs the casting can accomodate
        ods: List[Float], spring ods that can be accomodated
        castingod: Float, OD of the casting
        length: Float, Length of casting past the tail of the spring
        innerloss: Float, In a 2-spring Pipe Casting, the difference between where the outerspring is tailed and where the inner spring is tailed (otherwise 0)

"""
CASTINGS = [
    dict(name = "Standard 4 Pipe", type = "pipe", springs = 2, ods = [3.75, 2.75], castingod = 3.75, length = 3.0, innerloss = 3.0, weight = 0.0),
    dict(name = "Standard 6 Pipe", type = "pipe", springs = 2, ods = [5.625, 3.75], castingod = 5.75, length = 6.0, innerloss = 6.0, weight = 0.0),
    dict(name = "Standard 4 Spring", type = "spring", springs = 1, ods = [3.75,], castingod = 3.75, length = 3.0, innerloss = 0.0, weight = 0.0),
    dict(name = "Standard 6 Spring", type = "spring", springs = 1, ods = [5.625,], castingod = 5.75, length = 6.0, innerloss = 0.0, weight = 0.0),
    dict(name = "Standard 2 Spring", type = "spring", springs = 1, ods = [2.75,], castingod = 2.75, length = 1.0, innerloss = 0.0, weight = 0.0),
    ]
