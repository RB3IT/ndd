...
from NewDadsDoor.tests import helpers
...
def generatetrialdoor(trial):
    ...
    door = classes.Door(width = trial.get("width"),upset = trial.get('upset'))
    curtainargs = {k:trial.get(k,None) for k in ['stopheight','doortype',
                                            'slattype','slatgage','endlocktype',
                                            'bottombarangle','windlocks']}
    if trial.get("Safety Edge",None): curtainargs['bottombaredge'] = trial['Safety Edge']
    elif trial.get("Astragal Weight", None): curtainargs['bottombaredge'] = "ASTRAGAL"
    else: curtainargs['bottombaredge'] = None
    door.setcurtain(**curtainargs)
...
def test_upset(testdata = None, fail = True):
    ...
    return general_test("Upset",
              actualfunction=lambda trial: trial['door'].upset, targetfunction= lambda trial: floatify(trial['Upset']),
...
def test_openheight(testdata = None, fail = True):
    ...
    return general_test("Open Height",
                        actualfunction=lambda trial: trial['door'].openheight, targetfunction= lambda trial: 8.5,
                        errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_totalslats(testdata = None, fail = True):
    ...
    return general_test("Total Slats",
              actualfunction=lambda trial: trial['door'].gettotalslats(), targetfunction= lambda trial: floatify(trial['Total Number of Slats']),
...
def test_wrapslats(testdata = None, fail = True):
    ...
    return general_test("Wrap Slats",
              actualfunction=lambda trial: trial['door'].getwrapslats(), targetfunction= lambda trial: floatify(trial['Wrap']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_slatstocenterline(testdata = None, fail = True):
    ...
    return general_test("Slats to Centerline",
                 actualfunction=lambda trial: trial['door'].slatstocenterline, targetfunction= lambda trial: floatify(trial['Slats to Centerline']),
...
def test_turnstoraise(testdata = None, fail = True):
    ...
    return general_test("Turns to Raise",
                 ...
                 errormargin_numeric = .0011, errormargin_ratio = .0031, testdata = testdata, fail = fail)
...
def test_stopheight(testdata = None, fail = True):
    ...
    return general_test("Stop Height",
              actualfunction=lambda trial: trial['door'].curtain.stopheight, targetfunction= lambda trial: dadsmethods.convertmeasurement(trial['stopheight']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_slatlength(testdata = None, fail = True):
    ...
    out = []
    for trial in testdata:
        actual,target = trial['door'].curtain.slatlength,dadsmethods.convertmeasurement(trial['slatlength'])
        try: assertmargin(trial['jobnumber'], target, actual)   
            ...
            if (difference == .125 and trial['Wall Angle Thickness'] == "1/4") or\
                ...
                continue
            width = dadsmethods.convertmeasurement(trial['door'].width)
...
def test_bottombarweight(testdata = None, fail = True):
    ...
    return general_test("Bottom Bar Weight",
              actualfunction=lambda trial: trial['door'].curtain.getbottombarweight(), targetfunction= lambda trial: floatify(trial['Bottom Bar Weight']),
...
def test_bottombarheight(testdata = None, fail = True):
    ...
    return general_test("Bottom Bar Height",
              actualfunction=lambda trial: trial['door'].curtain.getbottombarheight(), targetfunction= lambda trial: floatify(trial['bottombarheight']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_getendlockweight(testdata = None, fail = True):
    ...
    return general_test("Endlock Weight",
              actualfunction=lambda trial: trial['door'].curtain.getendlockweight(), targetfunction= lambda trial: floatify(trial['Endlock Total Weight']),
...
def test_getslatweight_tocenterline(testdata = None, fail = True):
    ...
    return general_test("Slat Weight (to Centerline)",
              actualfunction=lambda trial: trial['door'].curtain.getslatweight(trial['door'].slatstocenterline), targetfunction= lambda trial: floatify(trial['slatweight to Centerline']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_perforatedweightloss(testdata = None, fail = True):
    ...
    return general_test("Perforated Weight Loss",
              actualfunction=lambda trial: trial['door'].curtain.perforatedweightloss, targetfunction= lambda trial: floatify(trial['Perforated Weight Loss']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_floortogrille(testdata = None, fail = True):
    ...
    return general_test("Floor to Grille",
              actualfunction=lambda trial: trial['door'].curtain.floortogrille, targetfunction= lambda trial: floatify(trial['Solid Bottom Height']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_getgrilleheight(testdata = None, fail = True):
    ...
    return general_test("Grille Height",
              actualfunction=lambda trial: trial['door'].curtain.getgrilleheight(), targetfunction= lambda trial: floatify(trial['Grille Height']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_getgrilleweight(testdata = None, fail = True):
    ...
    return general_test("Grille Weight",
              actualfunction=lambda trial: trial['door'].curtain.getgrilleweight(), targetfunction= lambda trial: floatify(trial['Grille Weight']),
              errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_increaseradius(testdata = None, fail = True):
    ...
    return general_test("Increase Radius",
                 actualfunction=lambda trial: trial['door'].curtain.slat.increaseradius, targetfunction= lambda trial: floatify(trial['increaseradius']),
                 errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_slatweight(testdata = None, fail = True):
    ...
    return general_test("Slat Weight",
                 actualfunction=lambda trial: trial['door'].curtain.slat.slatweight, targetfunction= lambda trial: floatify(trial['slatweight']),
...
def test_slatheight(testdata = None, fail = True):
    ...
    return general_test("Slat Height",
                 actualfunction=lambda trial: trial['door'].curtain.slat.slatheight, targetfunction= lambda trial: floatify(trial['slatheight']),
                 errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_bottombar_angleweight(testdata = None, fail = True):
    ...
    return general_test("Bottombar Angle Weight per Foot",
                 actualfunction=lambda trial: trial['door'].curtain.bottombar.angleweight, targetfunction= lambda trial: floatify(trial['bottombar angleweightperfoot']),
                 errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_bottombar_edgeweight(testdata = None, fail = True):
    ...
    return general_test("Bottombar Edge Weight per Foot",
                 actualfunction=lambda trial: trial['door'].curtain.bottombar.getedgeweight(), targetfunction= lambda trial: floatify(trial['Edge Weight']),
                 errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_bottombar_slopeweight(testdata = None, fail = True):
    ...
    return general_test("Bottombar Slope Weight",
                 actualfunction=lambda trial: trial['door'].curtain.bottombar.slopeweight, targetfunction= lambda trial: floatify(trial['Slope Weight']),
                 errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def test_bottombar_feederslatweight(testdata = None, fail = True):
    ...
    return general_test("Bottombar Feeder Slat Weight",
                 actualfunction=lambda trial: trial['door'].curtain.bottombar.getfeederslatweight(), targetfunction= lambda trial: floatify(trial['Feeder Slat Weight']),
...
def test_shell(testdata = None, fail = True):
    ...
    return general_test("Shell",
                        actualfunction = lambda trial: shellsize(trial['door'].pipe.shell), targetfunction = lambda trial: shellsize(trial.get('shell')),
                        errormargin_numeric = 0, errormargin_ratio = .00, testdata = testdata, fail = fail)
...
def general_bad_test(testfunction,attribute, testdata = None, measure = False, fail = True):
    ...
    if measure is True: attr = dadsmethods.tomeasurement(BADDATACONSTANT)
...
def test_slatlength_bad(testdata = None, fail = True):
    ...
    badtestdata = [{'jobnumber':test['jobnumber'], 'door':test['door'],
                    'slatlength': dadsmethods.tomeasurement(50000000000),
